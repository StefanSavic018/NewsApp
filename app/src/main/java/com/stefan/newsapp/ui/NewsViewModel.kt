...
import com.stefan.newsapp.NewsApplication
import com.stefan.newsapp.models.Article
import com.stefan.newsapp.models.NewsResponse
...
class NewsViewModel(
    ...
    fun searchNews(searchQuery: String) = viewModelScope.launch {
        safeSeaarchNewsCall(searchQuery)
    }
    ...
    private suspend fun safeSeaarchNewsCall(searchQuery: String) {
